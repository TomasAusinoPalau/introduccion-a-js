...
function probarValidarEdades () {
    console.assert(
        ...
        `La edad del integrante ${i+1} tiene que ser mayor a 0`,
        "edad Integrante no valido que la edad sea menor a 0",
    );
    console.assert(
        validarEdades([1, 4.5, 4, 2]) ===
        `La edad del integrante ${i+1} tiene que ser un número entero`,
        "edad Integrante no valido que la edad sea un número entero",
    );
    console.assert(
        validarEdades([`abc${4.5}`]) ===
        `La edad del integrante ${i+1} tiene que ser solo números`,
        "Edades no valido que la edad sea solo numeros",
    )
